...
<div id="container0">
    ...
    <a href="#default" class="logo">ESL NETWORK</a>
				<ul>
                    ...
                    <li><a href='tutoroom.php'>Tutor room</a></li>
...
<input type="button" value="Buy and Sell" class= "button button1" onclick="window.location.href='buyse dll.php'" />
</form>
...
<?php 
      ...
      for ($x = 0; $x<$trws; $x++) {
            ...
            if ($rws["category"]=="University Life") {
 ...
 ?>   
        ...
        <button type="button" class="w3-button w3-theme-d1 w3-margin-bottom" onclick="openForm()"><i class="fa fa-comment"></i>  Reply</button>
...
<div class="form-popup" id="myForm">
  <form action="action_page.php" >
    <textarea  placeholder="Enter Reply" name="reply"   cols='144' rows='6'></textarea><br>
