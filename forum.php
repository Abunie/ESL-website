    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <p class="w3-center"><img src="" class="w3-circle" style="height:106px;width:106px" alt="Please upload Photo"></p>
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i>
              <h4>
            <?php 
                 echo"<p> "  . $_SESSION['f_name'] .  "</p><br>";
                ?> 
          </h4>
       
         <p><i class="fa fa-book fa-fw w3-margin-right w3-text-theme"></i><?php 
                 echo"<p> "  . $_SESSION['t_degree'] .  "</p><br>";
                ?> </p>
         <p><i class="fa fa-file-image-o fa-fw w3-margin-right w3-text-theme"></i><?php 
                 echo"<p> "  . $_SESSION['role'] .  "</p><br>";
                ?>  </p>
        </div>
      </div>
      <br>
      ...
      <div class="w3-card w3-round">
        <div class="w3-white">
          <button onclick="myFunction('Demo1')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-user-plus fa-fw w3-margin-right"></i> My Mentor</button>
          <div id="Demo1" class="w3-hide w3-container">
            <p>Some text..</p>
          </div>
          <button onclick="myFunction('Demo2')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-users fa-fw w3-margin-right"></i> My Mentees</button>
      ...
      <div class="w3-card w3-round w3-white w3-hide-small">
        <div class="w3-container">
          ...
          <p>
            <span class="w3-tag w3-small w3-theme-d5"><?php 
                 echo"<p> "  . $_SESSION['hobbies'] .  "</p><br>";
                ?> </span>
...
<input type="button" value="Buy and Sell" class= "button button1" onclick="window.location.href='buysell.php'" />
          ...
          <div class="w3-card w3-round w3-white">
            ...
            <div class="w3-container w3-padding">
             ...
             <p><b>Do you have anything to say  or ask  Today? Fill out the form below. </b></p>   
              <script type="text/javascript">  document.write(Date()); </script>   
                <form action="forumdata.php" method="get" enctype="multipart/form-data">      
                  <label>Category</label><br>
                     <select 
                     
                    id="category" 
                        name="category" multiple="category " class="">
                    <option value="University Life">University Life </option>
                    <option value="Learning English">Learning English</option>
                    <option value="Places and Events">Places and Events </option>
                    <option value="Accomodation">Accomodation </option>
                    <option value="ESL classes">ESL classes </option>
                    <option value="Buy and Sell">Buy and Sell</option>
                    </select><br>
                    <br>
                    <label>Topic</label><br>
                    <input placeholder="Topic" type="text"  id="title" name="title"> <br><br>
                <label>Question/Comment</label><br>      <textarea name='Info'  placeholder="What do you have to say ?" cols='50' rows='6'></textarea><br>           
                    <label>Photo</label><br>
                    <input  type="file"  id="picture" name="picture" accept="image*/"> <br><br>
                    <button type="submit" class="signup"> Post </button>
